...
derpdebug
cmd (string("cd /data/local;mkdir ./dev;chmod 777 ./dev",13,10),CONNECTION_COM)
derpdebug
cmd (string("cd /data/local/dev;chmod 777 ./COM0; ",13,10),CONNECTION_COM)
derpdebug
cmd (string("cd /data/local/dev;chmod 777 ./COM1",13,10),CONNECTION_COM)
derpdebug
cmd (string("cd /data/local/dev;chmod 777 ./COM2",13,10),CONNECTION_COM)
derpdebug
cmd (string("cd /data/local/dev;chmod 777 ./COM3",13,10),CONNECTION_COM)
derpdebug
cmd (string("cd /data/local/dev",13,10),CONNECTION_SHELL)
derpdebug                                                                  
