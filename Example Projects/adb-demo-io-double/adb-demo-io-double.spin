{{
OBEX LISTING:
  http://obex.parallax.com/object/117

  Lets your Prop talk to two Android devices at the same time or, using the modified usb-fs-host,
  one Android device and one other USB device.
}}
CON
